...
public interface SalesService {
	...
	public SalesVO payableInfo(PayablesVO salesVO); 	// 채무거래 단건 조회
	...
	public int insertPayable(PayablesVO salesVO);		// 채무거래 추가
	...
	public int updatePayable(PayablesVO salesVO);		// 채무거래 단건 수정

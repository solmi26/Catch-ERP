...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("save-btn").addEventListener("click", function (event) {
    ...
    const purchaseSlip = document.querySelector("input[name='p_joinInput']").value; // 구매전표 번호
  ...
  document.getElementById("p_openAcctModal").addEventListener("click", function () {
    acctModal.show();
  ...
  //모달실행 시 grid refresh를 위한 코드
  document.getElementById("p_openClientModal").addEventListener("click", function () {
    clientModal.show();
    window.setTimeout(function () {
      console.log(p_grid3);
